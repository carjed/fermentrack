    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addl_data_point1', models.DecimalField(decimal_places=6, default=None, help_text='(Optional) Additional logged data point 1 (e.g. bpm)', max_digits=13, null=True)),
                ('addl_data_point2', models.DecimalField(decimal_places=6, default=None, help_text='(Optional) Additional logged data point 1 (e.g. total bubbles)', max_digits=13, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor_type', models.CharField(choices=[('tilt', 'Tilt Hydrometer'), ('ispindel', 'iSpindel'), ('brewbubbles', 'brewbubbles'), ('plaato', 'plaato'), ('manual', 'Manual')], default='manual', help_text='Type of gravity sensor used', max_length=14)),
                ...
                ('log_gravity', models.BooleanField(default=True, help_text='For sensors (such as Brew Bubbles) that primarily log things other than gravity do we want to log the (estimated) gravity readings they make available?')),
                ('log_temp', models.BooleanField(default=True, help_text='Although most gravity sensors provide temperature readings,we may not always want to log them. Set this false toignore them.')),
                ('active_log', models.ForeignKey(blank=True, default=None, help_text='The currently active log of readings', null=True, on_delete=django.db.models.deletion.SET_NULL, to='gravity.GravityLog')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mdns_id', models.CharField(help_text="mDNS ID used by the TiltBridge to identify itself both on your network and to Fermentrack. NOTE - Prefix only - do not include '.local'", max_length=64, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z0-9]+[a-zA-Z0-9-]+[a-zA-Z0-9]+$')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiltbridge', models.ForeignKey(blank=True, default=None, help_text='TiltBridge device to use (if any)', null=True, on_delete=django.db.models.deletion.SET_NULL, to='gravity.TiltBridge')),
            ],
        ),
        migrations.AddField(
