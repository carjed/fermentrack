    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, help_text='Name of the beer being logged (must be unique)', max_length=255)),
                ('created', models.DateTimeField(default=django.utils.timezone.now, help_text='When the beer log was initially created')),
                ('format', models.CharField(default='F', help_text='Temperature format to write the logs in', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('udev_serial_number', models.CharField(blank=True, default='', help_text='USB Serial ID number for autodetection of serial port', max_length=255)),
                ...
                ('wifi_host_ip', models.CharField(blank=True, default='', help_text='Cached IP address in case of mDNS issues (only used if connection_type is wifi)', max_length=46)),
                ...
                ('active_beer', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Beer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_type', models.CharField(default='Standard Profile', help_text='Type of temperature profile', max_length=32)),
                ('notes', models.TextField(blank=True, default='', help_text='Notes about the fermentation profile (Optional)')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_function', models.IntegerField(choices=[(0, 'NONE'), (1, 'Chamber Door'), (2, 'Heating Relay'), (3, 'Cooling Relay'), (4, 'Chamber Light'), (5, 'Chamber Temp'), (6, 'Room (outside) Temp'), (7, 'Chamber Fan'), (8, 'Chamber Humidity'), (9, 'Beer Temp')], default=0)),
                ...
                ('controller', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.BrewPiDevice')),
                ('pin_data', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.PinDevice')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fridge_humidity', models.DecimalField(decimal_places=10, max_digits=13, null=True)),
                ...
                ('gravity', models.DecimalField(decimal_places=3, max_digits=5, null=True)),
                ('gravity_temp', models.DecimalField(decimal_places=10, max_digits=13, null=True)),
                ('associated_beer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.Beer')),
            ],
            options={
